...
public class GamePanel extends JPanel implements Runnable {
		...
		private FallingWord[] wordsx;
		private int noWords;
		private int noWordsx;
		private final static int borderWidth=25; //appearance - border

		GamePanel(FallingWord[] words,FallingWord [] wordsx, int maxY,	
		   ...
		   //draw the words
		    if (!started.get()) {
				...
				for (int i=0;i<noWordsx;i++){	   
		    		...
		    		g.drawString(wordsx[i].getWord(),wordsx[i].gethaX()+borderWidth,wordsx[i].gethaY());
