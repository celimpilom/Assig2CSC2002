...
//shared class variables
	...
	static FallingWord[] wordsx;
	static WordMover[] wrdShft;
	static HungryWordMover[] wrdShftx;
	...
	public static void setupGUI(int frameX,int frameY,int yLimit) {
		...
		gameWindow = new GamePanel(words,wordsx,yLimit,done,started,won);
	...
	public static void createHWordMoverThreads() {
		score.reset();
	  	//initialize shared array of current words with the words for this game
		for (int i=0;i<noWordsx;i++) {
			wordsx[i]=new FallingWord(dict.getNewWord(),gameWindow.getValidXpos(),yLimit,xLimit);
		}
		//create threads to move them
	    for (int i=0;i<noWordsx;i++) {
...
public static void main(String[] args) {
		...
		wordsx = new FallingWord[noWordsx];
